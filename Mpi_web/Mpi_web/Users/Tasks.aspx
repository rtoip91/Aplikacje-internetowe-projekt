...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        <td>
            <asp:Label ID="Label1" runat="server" Text="Liczba w zadaniu:" Visible="False"></asp:Label>
        </td>
        <td>
    ...
    <tr>
        <td>
            <asp:Label ID="Label4" runat="server" Text="Czas rozpoczęcia:" Visible="False"></asp:Label>
        </td>
        <td>
            <asp:TextBox ID="TextBox4" runat="server" Visible="False" ReadOnly="True"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td>
            <asp:Label ID="Label5" runat="server" Text="Czas zakończenia:" Visible="False"></asp:Label>
        </td>
        <td>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="TextBox6" runat="server" Visible="False" ReadOnly="True"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td>
            <asp:Label ID="Label7" runat="server" Text="Wynik2:" Visible="False"></asp:Label>
        </td>
        <td>
            <asp:TextBox ID="TextBox7" runat="server" Visible="False" ReadOnly="True"></asp:TextBox>
        </td>
    </tr>
    <tr>
        <td>
            <asp:Label ID="Label8" runat="server" Text="Użyty algorytm:" Visible="False"></asp:Label>
        </td>
        <td>
